        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="mt-3 flex gap-3">
              ...
              <a href={profile.socials.github} target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-400 hover:text-black dark:hover:text-white transition-colors" aria-label="GitHub">
                <GitHubIcon size={22} />
              </a>
              ...
              <a href={profile.socials.twitter} target="_blank" rel="noopener noreferrer" className="text-slate-500 dark:text-slate-400 hover:text-black dark:hover:text-white transition-colors" aria-label="X / Twitter">
                <XIcon size={22} />
              </a>
